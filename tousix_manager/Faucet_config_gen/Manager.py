...
class Manager(object):
    ...
    def triangle(self, list_load = []):
        ...
        data = {'vlans': {'tousix': {'vid': 100, 'description': qs(self.vlan_name)}}, 'dps': {
            'Edge1': {'dp_id': HexInt(Switch.objects.get(nomswitch="Edge 1").id), 'hardware': qs(Switch.objects.get(nomswitch="Edge 1").faucet_class), 'interfaces': {
                ...
                int(settings.FAUCET_SETTINGS['sw1_portnum_to_sw3']): {'name': qs('link'), 'description': qs('link'), 'native_vlan': 100,
                                          'acl_in': 1, 'opstatus_reconf': False}}
                      }, 'Edge2': {'dp_id': HexInt(Switch.objects.get(nomswitch="Edge 2").id), 'hardware': qs(Switch.objects.get(nomswitch="Edge 2").faucet_class), 'interfaces': {
                ...
                int(settings.FAUCET_SETTINGS['sw2_portnum_to_sw3']): {'name': qs('link'), 'description': qs('link'), 'native_vlan': 100,
                                          'acl_in': 2, 'opstatus_reconf': False}}},
            'Edge3': {'dp_id': HexInt(Switch.objects.get(nomswitch="Edge 3").id), 'hardware': qs(Switch.objects.get(nomswitch="Edge 3").faucet_class), 'interfaces': {
